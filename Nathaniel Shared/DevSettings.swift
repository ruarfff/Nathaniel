    ...
    public class DevSettings: Codable {
        ...
        public func reset() {
            ...
            nathanielSpeed = 70
            hermesSpeed = 40
            nathanielMaxHealth = 8_000
            hermesMaxHealth = 2_000
        ...
        public required init(from decoder: Decoder) throws {
            ...
            nathanielMaxHealth = try container.decodeIfPresent(Int.self, forKey: .nathanielMaxHealth) ?? 8_000
            hermesMaxHealth = try container.decodeIfPresent(Int.self, forKey: .hermesMaxHealth) ?? 2_000
