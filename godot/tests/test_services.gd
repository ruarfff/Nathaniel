...
const Settings = preload("res://scripts/services/settings_store.gd")
const Progress = preload("res://scripts/services/progress_store.gd")
const DebugServer = preload("res://scripts/services/debug_server.gd")
...
func _initialize() -> void:
	directory = "/tmp/nathaniel-godot-services-%d-%d" % [OS.get_process_id(), Time.get_ticks_usec()]
	call_deferred("_run")
...
func _test_slots() -> void:
	...
	var state: Dictionary = LegacyImport.convert(_swift_fixture(), _level()).state
